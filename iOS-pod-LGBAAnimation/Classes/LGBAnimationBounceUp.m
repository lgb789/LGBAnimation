...
#import "LGBAnimationBounceUp.h"

@implementation LGBAnimationBounceUp
...
+(void)startAnimationOnView:(UIView *)view delay:(CGFloat)delay duration:(CGFloat)duration complete:(void (^)(void))complete
{
    ...
    view.transform = CGAffineTransformMakeTranslation(0, CGRectGetHeight([UIScreen mainScreen].bounds) - CGRectGetMinY(frame));
